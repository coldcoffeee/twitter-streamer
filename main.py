...
import re
import os
os.system('echo "" > tweets.json')
os.system('echo "" > tweets.txt')
...
if __name__ == '__main__':
    ...
    path = input("Search for recent, popular or stream tweets? ")
    ...
    if(path == 'recent'):
        ...
        os.system("clear")
        os.system("python3 tweepy_streamer.py")
